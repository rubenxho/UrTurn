...
export class ClienteOpinionesResenarService {
  ...
  getEmpresaVisitadasDeCliente(id_usuario_cliente: number) {
    return this.http.get(`${this.url}/opiniones/empresa_visitada?id_usuario_cliente=${id_usuario_cliente}`);
  }
  ...
  getOpinionesACliente(id_usuario_cliente: number) {
    return this.http.get(`${this.url}/opiniones?id_usuario_cliente=${id_usuario_cliente}`);
  }
  ...
  getOpinionesAEmpresa(id_usuario_empresa: number) {
    return this.http.get(`${this.url}/opiniones?id_usuario_empresa=${id_usuario_empresa}`);
  }
}
